...
<html>
	<head>
		...
		<title>Projects | <?php echo $_ng_conf['current']['page']; ?></title>
		...
		<!-- style available in the specific project -->
		<link rel="stylesheet" media="all" href="<?php echo $_ng_conf['domains']['projects'] . $fullprj . $_ng_conf['medias']['css']; ?>/styles.css"></link>
		...
		<script type="text/javascript" src="<?php echo $_ng_conf['domains']['projects'] . $_ng_conf['projects']['template']['path'] . $_ng_conf['medias']['js']; ?>/script.js"></script>
	</head>
	<body>
<?php
